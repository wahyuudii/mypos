...
<head>
    ...
    <title>myPos | by Fastcloth</title>
...
<div class="wrapper">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?=base_url()?>assets/dist/img/gambar2.jpeg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?=$this->fungsi->user_login()->username?></span>
            </a>
            <ul class="dropdown-menu">
              <li class="user-header">
                <img src="<?=base_url()?>assets/dist/img/gambar2.jpeg" class="img-circle" alt="User Image">
    ...
    <section class="sidebar">
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?=base_url()?>assets/dist/img/gambar2.jpeg" class="img-circle">
        </div>
        <div class="pull-left info">
          <p><?=ucfirst($this->fungsi->user_login()->username)?>Fastcloth</p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <a href="<?=site_url('supplier')?>"><i class="fa fa-truck"></i> <span>Supliers</span></a>
        </li>
  ...
  <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2021 <a href="https://adminlte.io">Fastcloth</a>.</strong> All rights
      reserved.
  </footer>
</div>
