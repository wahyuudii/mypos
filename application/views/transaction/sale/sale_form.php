<section class="content-header">
            ...
            <div class="box box-widget">
                <div class="box-body" >
                    <table width="100%" >
                        ...
                        <tr>
                            <td style="vertical-align:top" >
                                <label for="customer">Customer</labe>
                            </td>
                            <td>
                                <div>
            ...
            <div class="box box-widget">
                <div class="box-body">
                    <div align="right">
                        ...
                        <h1><b><span id="grand_total2" stye="font-size:50pt">0</span></b></h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="box-body">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input type="number" id="change" class="form-control" readonly></input>
                                </div>
                            </td>
                        </tr>
                    </table>               
    ...
    <div class="col-lg-3">
        <div>
            <button id="cancel_payment" class="btn btn-flaf btn-warning">
